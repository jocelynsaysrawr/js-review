...
console.log("Burj Khalifa Floors:", numberOfFloorsBurjKhalifa);

var TokyoOlympicsYear = 2020;
console.log("Tokyo Olympics:", TokyoOlympicsYear);
...
var japanPrefectures = ["Hokkaido", "Iwate", "Chiba", "Tokyo", "Osaka"];
console.log("Places in Japan:", japanPrefectures);
console.log("Japan 1:", japanPrefectures[0]);
console.log("Japan 3:", japanPrefectures[2]);
...
console.log("Pluto don't live here no more...but we do!:", planets);
console.log("You are here:", planets[2]);
console.log("Awkward Giggles because of:", planets[6]);
